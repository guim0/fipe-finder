...
// Exports
module.exports = {
	"modal": "CheckUppercase_modal__CnvrF"
};
...
;// CONCATENATED MODULE: ./src/hooks/formatData.ts
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                dangerouslySetInnerHTML: {
                                    __html: JSON.stringify(formattedObj1)
                                }
                            })
                        ]
                    })
...
;// CONCATENATED MODULE: ./src/hooks/Mask.ts
const Mask = (value)=>{
    let hideChar = [];
...
;// CONCATENATED MODULE: ./src/hooks/checkFirstLetterUppercase.ts
function checkFirstLetterUpcase(word) {
    return word.charCodeAt(0) >= 65 && word.charCodeAt(0) <= 90;
}

// EXTERNAL MODULE: ./src/components/CheckUppercase/CheckUppercase.module.scss
var CheckUppercase_module = __webpack_require__(1682);
var CheckUppercase_module_default = /*#__PURE__*/__webpack_require__.n(CheckUppercase_module);
;// CONCATENATED MODULE: ./src/components/CheckUppercase/index.tsx




const CheckUppercase = (props)=>{
    const { 0: value , 1: setValue  } = (0,external_react_.useState)("");
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("main", {
        className: (CheckUppercase_module_default()).modal,
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("h1", {
...
const Button = (external_styled_components_default()).a`
...
function Home() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(CheckUppercase, {
                title: "Checando se primeira \xe9 verdadeiro"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Button, {
                href: "/search",
                children: "Clique para ir a p\xe1gina de pesquisa"
            })
        ]
    });
}
